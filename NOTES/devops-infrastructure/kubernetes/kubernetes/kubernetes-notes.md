...
The service is created exactly the same without you having to do any additional steps during the service creation for all 3:
1. single pod in a single node
2. multiple pods on a single node
3. multiple pods on multiple nodes
